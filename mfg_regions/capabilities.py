...
class Capabilities:
    ...
    def _extract_data(self):
        ...
        self.APB_min_width = self.APB_min_throat_width + 2 * (self.APB_max_flange_length * 6/8)
    ...
    def plot_feasible_regions(self):
        ...
        if self.gauge >= 10:
            ...
            plt.axvline(self.APB_min_width, color=self.region_colors['APB'], linestyle=':', label=f'APB min: x = {self.APB_min_width}')
            plt.axvline(self.APB_min_length, color=self.region_colors['APB'], linestyle=':', label=f'APB min: y = {self.APB_min_length}')
