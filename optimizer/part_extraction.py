...
def get_wall_parts(frame, design_name):
    ...
    panel_bends = 4
    panel_class = _get_assy_category(cap, panel_gauge, panel_material, panel_height, panel_width)
...
def get_floor_parts(floor, design_name):
    ...
    panel_bends = 4
    b_panel_class = _get_assy_category(cap, panel_gauge, panel_material, b_panel_length, b_panel_width)
    ...
    if not all_same:
        ...
        t_panel_class = _get_assy_category(cap, panel_gauge, panel_material, t_panel_length, t_panel_width)
